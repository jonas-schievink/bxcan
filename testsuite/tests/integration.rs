...
impl State {
    fn init() -> Self {
        ...
        let (can1, can2) = testsuite::init(periph.CAN1, periph.CAN2, &mut periph.RCC);
...
mod tests {
    ...
    /// Performs an external roundtrip from CAN1 to CAN2.
    ///
    ...
    fn ext_roundtrip(state: &mut State) {
        ...
        // TODO: This won't pass until GPIOs are set up correctly (Alternate Function etc.)
    }
}
